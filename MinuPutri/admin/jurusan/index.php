...
$query = mysqli_query($koneksi, "SELECT tbl_kelas.id AS id, tbl_kelas.nama_kelas, tbl_kelas.walikelas, tbl_guru.nama, tbl_guru.id AS id_guru FROM tbl_kelas LEFT JOIN tbl_guru on tbl_kelas.walikelas = tbl_guru.id");
$no = 1;
$active = 'master';
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Data Kelas - SD MINU "PUTRI" MALANG</title>
