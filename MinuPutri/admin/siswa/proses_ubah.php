...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		// ubah data
		$query = mysqli_query($koneksi, "UPDATE tbl_siswa SET nama = '$nama', nis = $nis, jenis_kelamin = '$jenis_kelamin', tempat_lahir = '$tempat_lahir', tanggal_lahir = '$tanggal_lahir', alamat = '$alamat', foto = '$nama_foto', id_kelas = $id_kelas WHERE id = $id") or die(mysqli_error($koneksi));
		if($query){
