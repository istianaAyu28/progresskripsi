...
$query = mysqli_query($koneksi, "SELECT tbl_siswa.id, tbl_siswa.nama, tbl_siswa.no_hp, tbl_siswa.foto, tbl_siswa.alamat, tbl_kelas.nama_kelas AS kelas FROM tbl_siswa LEFT JOIN tbl_kelas ON tbl_siswa.id_kelas = tbl_kelas.id");
$no = 1;
$active = 'master';
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Data Siswa - SD MINU "PUTRI" MALANG</title>
