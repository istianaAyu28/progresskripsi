...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT tbl_siswa.*, tbl_kelas.nama_kelas FROM tbl_siswa LEFT JOIN tbl_kelas ON tbl_siswa.id_kelas = tbl_kelas.id WHERE tbl_siswa.id = $id");
...
<head>
	...
	<title>Detail Siswa -SD MINU "PUTRI" MALANG</title>
