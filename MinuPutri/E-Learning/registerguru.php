            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="/Progres9/MinuPutri/E-learning/admin/login.php" class="active">Login</a></li>
                            <li class="button"><a href="/progres9/MinuPutri/">Website</a></li>
                           
                            <li class="main-button"><a href="/Progres9/MinuPutri/E-learning/admin/registerguru.php">Daftar</a></li>
                        </ul>        
                ...
                <div class="row">
                    ...
                    <br>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            NIP* :<input type="text" name="nip" class="form-control" required />
                        ...
                        if(@$_POST['daftar']) {
                            ...
                            $sql_cek_user = mysqli_query($db, "SELECT * FROM tb_pengajar WHERE username = '$user'") or die ($db->error);
                            if(mysqli_num_rows($sql_cek_user) > 0) {
                                ...
                                if($nama_gambar != '') {
                                    if(move_uploaded_file($sumber, $target.$nama_gambar)) {
                                        mysqli_query($db, "INSERT INTO tb_pengajar VALUES('', '$nip', '$nama_lengkap', '$tempat_lahir', '$tgl_lahir', '$jenis_kelamin', '$agama',  '$no_telp', '$email', '$alamat', '$nama_gambar', '$status', '$user', md5('$pass'), '$pass', 'tidak aktif')") or die ($db->error);          
                                    ...
                                    mysqli_query($db, "INSERT INTO tb_pengajar VALUES('', '$nip', '$nama_lengkap', '$tempat_lahir', '$tgl_lahir', '$jenis_kelamin', '$agama', '$nama_ayah', '$nama_ibu', '$no_telp', '$email', '$alamat',,'$status', 'anonim.png', '$user', md5('$pass'), '$pass', 'tidak aktif')") or die ($db->error);          
                    ...
                    <br>
                        ...
                        <div class="alert alert-warning">
                         Anda sudah punya akun ? Silahkan <a href="./admin/" class="btn btn-xs btn-danger">Login</a>
                          </div>
                    </div>
                </div>
            <?php
