...
$pdf->Image('../../style/assets/img/logosd.png',15,18,16);
$pdf->SetTitle("Cetak Data");
$pdf->SetFont('Arial','B',18);
$pdf->Cell(0,5,'MADRASAH IBTIDAIYAH NU PUTRI MALANG','0','1','C',false);
$pdf->SetFont('Arial','i',8);
$pdf->Cell(0,5,'Alamat : Jl. Yulius Usman No.14 B, Kasin, Kec. Klojen, Kota Malang, Jawa Timur 65117','0','1','C',false);
$pdf->Cell(0,2,'Telp : (0341) 359490 - Email : sdminu@yahoo.com','0','1','C',false);
$pdf->Ln(3);
...
if(@$_GET['data'] == "pengajar") {
	...
	$pdf->SetFont('Arial','B',11);
	$pdf->Cell(50,5,'Laporan Daftar Kelas, Letak Ruang, Wali dan Ketua Masing-masing Kelas di Madrasah Ibtidaiyah','0','1','L',false);
	$pdf->Ln(3);
...
$pdf->Cell(0,0,"Malang, ".tgl_indo(date('Y-m-d')),0,0,'L');
