	                            ...
	                            while($data_mapel = mysqli_fetch_array($sql_mapel)) { ?>
	                                <tr>
	                                    ...
	                                    <td align="center" width="150px">
	                                        <a href="?page=mapel&action=edit&id=<?php echo $data_mapel['id']; ?>" class="btn second" style="background-color:#ADD8E6;">Edit</a>
	                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=mapel&action=hapus&id=<?php echo $data_mapel['id']; ?>" class="btn second" style="background-color:#FA8072;">Hapus</a>
                                            <a href="?page=quiz&action=tampil&id=<?php echo $data_quiz['id_quiz']; ?>&quiz=<?php echo $data_quiz['id_mapel']; ?>" class="btn second" style="background-color:#FAEBD7;">Lihat Quiz</a>
	                                    </td>
	                                </tr>
	                            <?php
	                            }
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php
    } else if(@$_GET['action'] == 'tampil') { ?>
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Quiz&nbsp; <a href="?page=quiz" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
                    	<?php
                    	$sql_quiz_id = mysqli_query($db, "SELECT * FROM tb_topik_quiz WHERE id = '$id'") or die ($db->error);
                    	$data_quiz_id = mysqli_fetch_array($sql_quiz_id);
                    	?>
                        <div class="form-group">
                            <label>Judul *</label>
                            <td name="judul" value="<?php echo $data_quiz_id['judul']; ?>" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label>Mapel *</label>
                            <td name="mapel" value="<?php echo $data_quiz_id['id_mapel']; ?>" class="form-control"  />
                        </div>
                        <div class="form-group">
                            <input type="submit" name="simpan" value="Simpan" class="btn btn-success" />
                            <input type="reset" value="Reset" class="btn btn-danger" />
                            ...
                            if(mysqli_num_rows($sql_mapel_ajar) > 0) {
	                            while($data_mapel_ajar = mysqli_fetch_array($sql_mapel_ajar)) { ?>
	                                <tr>
	                                    ...
	                                    <td align="center" width="150px">
	                                        <a href="?page=mapel&action=edit&id=<?php echo $data_mapel_ajar[0]; ?>" class="btn second" style="background-color:#ADD8E6">Edit</a>
	                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=mapel&action=hapus&id=<?php echo $data_mapel_ajar[0]; ?>" class="btn second" style="background-color:#FA8072;">Hapus</a>
                                            <a href="?page=quiz" class="btn second" style="background-color:#ADD8E6;">Quiz</a>
	                                    </td>
	                                </tr>
	                            <?php
	                            }
