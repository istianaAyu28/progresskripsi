...
if(@$_SESSION['admin']) {
                            ...
                            while($data_kelas = mysqli_fetch_array($sql_kelas)) { ?>
                                <tr>
                                    ...
                                    <td align="center" width="200px">
                                        <a href="?page=kelas&action=edit&id=<?php echo $data_kelas['id_kelas']; ?>" class="btn second" style="background-color:#ADD8E6;">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=kelas&action=hapus&id=<?php echo $data_kelas['id_kelas']; ?>" class="btn second" style="background-color:#FA8072;">Hapus</a>
                                        <a href="?page=siswa&IDkelas=<?php echo $data_kelas['id_kelas']; ?>&kelas=<?php echo $data_kelas['nama_kelas']; ?>" class="btn second" style="background-color:#FAEBD7;">Lihat Siswa</a>
                                    </td>
                                </tr>
                            <?php
                            } ?>
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Kelas yang Anda Ajar  &nbsp; <a href="?page=kelas&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a></div></div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
