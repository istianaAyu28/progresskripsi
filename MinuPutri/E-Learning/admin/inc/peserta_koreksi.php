 <div class="row">
        ...
        <div class="panel-body">
                ...
                <?php if(mysqli_num_rows($sql_siswa_mengikuti_tes) > 0) { ?>
                    <a href="./laporan/cetak.php?data=quiz&id_tq=<?php echo $id_tq; ?>" target="_blank" class="btn btn-default btn-sm">PDF</a>
                    <a href="./laporan/data.php?data=quiz&id_tq=<?php echo $id_tq; ?>" target="_blank" class="btn btn-default btn-sm">Excel</a>
                <?php } ?>
            </div>
        </div>
	</div>
