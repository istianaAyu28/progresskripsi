                            ...
                            if(mysqli_num_rows($sql_topik) > 0) {
                                while($data_topik = mysqli_fetch_array($sql_topik)) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="?page=quiz&action=edit&id=<?php echo $data_topik['id_tq']; ?>" class="btn second" style="background-color:#ADD8E6;">Edit</a>
                                            <a onclick="return confirm('Hati-hati saat menghapus topik quiz karena Anda akan menghapus semua data yang berhubungan dengan topik ini, termasuk data soal dan nilai. Apakah Anda tetap yakin akan menghapus topik ini?');" href="?page=quiz&action=hapus&id_tq=<?php echo $data_topik['id_tq']; ?>" class="btn second" style="background-color:#FA8072;">Hapus</a>
                                            <br /><a href="?page=quiz&action=buatsoal&id=<?php echo $data_topik['id_tq']; ?>" class="btn second" style="background-color:#E6E6FA;">Buat Soal</a>
                                            <a href="?page=quiz&action=daftarsoal&id=<?php echo $data_topik['id_tq']; ?>" class="btn second" style="background-color:#FFE4C4;">Daftar Soal</a>
                                            <a href="?page=quiz&action=pesertakoreksi&id_tq=<?php echo $data_topik['id_tq']; ?>" class="btn second"style="background-color:#FFE4B5;">Peserta & Koreksi</a>
                                        </td>
                                    </tr>
                                <?php
                                }
                ...
                <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="rms_pg" name="rms_pg" class="form-control" step="0.01" placeholder="Ex: 0.40" min="0.01" max="0.99" required />
                        </div>
                        <div class="form-group">
                            <label>Essay *</label>
                            <input type="decimal" id="rms_esay" name="rms_esay" class="form-control" step="0.01" placeholder="Ex: 0.60 " min="0.01" max="0.99" required />
                        </div>
                        <div class="form-group">
                            <label>Info</label>
                    ...
                    $(".save").click(function() {
                        ...
                        for(var i = 1; i <= ke; i++) {
                            ...
                            $.ajax({
                                ...
                                type : 'post',
                                data : 'judul='+judul+'&mapel='+mapel+'&tgl_buat='+tgl_buat+'&waktu_soal='+waktu_soal+'&info='+info+'&status='+status+'&pembuat='+pembuat+'&kelas='+kelas+'&rms_pg='+pg+'&rms_esay='+esay,
