                			...
                			while($data_nilai_pilgan = mysqli_fetch_array($sql_cek_nilai_pilgan)) { ?>
                				<tr>
                					...
                					<td>
                                        ...
                                        Nilai: <?php echo $data_nilai_pilgan['presentase']; ?>
                                    </td>
                					<?php
									...
									$sql_rumus = mysqli_query($db, "SELECT * FROM tb_rumus WHERE id_rumus = 1 ") or die ($db->error);
									$data_jawaban = mysqli_fetch_array($sql_cek_jawaban);
									$rumus = mysqli_fetch_array($sql_rumus);
