...
if($prosen)
returnround(($this->jaccard_coefficient*100),2);
else
...
//langkah 2 : buat N-Gram74.$this->arr_n_gram1=$this->n_gram($this->word1,$this->n_gram_value);
$this->arr_n_gram2=$this->n_gram($this->word2,$this->n_gram_value);
//langkah 3 : rolling hash untuk masing-masing n gram78.$this->arr_rolling_hash1=$this->rolling_hash($this->arr_n_gram1);
