<nav class="navbar navbar-expand-lg nav-orange">
	...
	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		<div class="navbar-nav">
			...
			<a class="nav-item nav-link text-white navlink <?= $aktif == 'tentang_website' ? 'active' : '' ?>" href="tentang_website.php">TENTANG SEKOLAH</a>
			<!-- <a class="nav-item nav-link text-white navlink <?= $aktif == 'login' ? 'active' : '' ?>" href="/progres9/MinuPutri/login.php">LOGIN ADMIN</a> -->
			<a class="nav-item nav-link text-white navlink " href="/progres9/MinuPutri/E-Learning/">E-LEARNING</a>
		</div>
	</div>
</nav>